          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                ...
                <span class="nav-profile-name"><?php echo e($data->name); ?></span>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item" href="<?php echo e(route('deconnexion-utilisateur')); ?>">
...
<?php /**PATH C:\Users\DELL PC\Downloads\dashboard-oukale-19f6487b67badb095dd006b0adbadf6067e039f2\resources\views/partials/navbar.blade.php ENDPATH**/ ?>